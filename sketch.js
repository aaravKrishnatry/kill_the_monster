...
function setup() {
  ...
  //level one
  block1 = new Block(300,275,20,20);
  console.log(block1);
  block2 = new Block(330,275,20,20);
  block3 = new Block(360,275,20,20);
  block4 = new Block(390,275,20,20);
  block5 = new Block(420,275,20,20);
  block6 = new Block(450,275,20,20);
  block7 = new Block(480,275,20,20);
  //level two
